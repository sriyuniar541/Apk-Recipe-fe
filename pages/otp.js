...
export default function Otp() {
  ...
  const registerHandling = async (e) => {
    ...
    const res = await (
      await fetch(
        "https://courageous-lime-jaguar.cyclic.app/users/email/verif",
        {
          method: "POST",
      ...
      <div className="row">
        ...
        >
          <form
            ...
            className="col-lg-6 offset-lg-3 p-5 p-lg-1"
          >
            ...
            <input
              ...
              onChange={onChangeHandler}
            />
            <button className=" text-center btn btn-warning col-lg-6 offset-lg-3 mt-4 text-white">
              Send
            </button>
          </form>
        </div>
