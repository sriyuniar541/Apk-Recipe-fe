          ...
          <div className='container px-5'>
            ...
            <div className='d-flex justify-content-between'>
              <div className='col-5' style={{ paddingTop: '20%', paddingBottom: '20%' }}>
                ...
                <input type="name" className='form-control' id="search" placeholder='Search Recipe' style={{ height: 'auto' }} value={search} onChange={e => setSearch(e.target.value)}>
                </input>
              </div>
              <div className='col-7'>
                <img src='/g2.png' alt='' style={{ width: '30%', marginLeft: '30%', zIndex: 3, position: 'absolute' }} />
              </div>
            </div>
          </div>
        </div>
            ...
            if (i < 1) {
              return (
                <div  className='row d-flex justify-content-between' key={p.id}>
                  <div className='col-4 '>
                    <img src={p.photo} alt='' style={{ width: '25%', zIndex: 3, position: 'absolute', marginLeft: '3%', marginTop: '3%' }} />
                  ...
                  <div className='col-4' style={{ padding:'5%' }}>
                    ...
                    <hr />
                    <p>{p.description}</p>
                    <Link href={`/recipe/${p.id}`}><button className='btn btn-warning text-white'>Learn More</button></Link>
                  </div>
                </div>
              )
            }
