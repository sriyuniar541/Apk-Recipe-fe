...
export default function Footer() {
  return (
    <div className='bg-warning text-center' style={{width:'100%',height:'341px',padding:'100px'}}>
      <h1 style={{color:'#2E266F'}}>Eat, Cook, Repeat</h1>
      <p style={{color:'#707070'}}>Share your best recipe by uploading here !</p>
      <div className='d-flex justify-content-center mt-5'style={{color:'#707070'}}>
